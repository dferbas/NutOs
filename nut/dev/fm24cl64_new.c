...
{
	return TwMasterRegRead(slaveAddress, addr, 2, rxdata, rxsiz, tmo);
}
...
{
	return TwMasterRegWrite(slaveAddress, addr, 2, (void *)txdata, txsiz, tmo);
}
...
{
	return TwMasterRegRead(slaveAddress, addr, 2, (void *)rxdata, 1, FRAM_RW_TIMEOUT);
}
...
{
	return TwMasterRegWrite(slaveAddress, addr, 2, (void *)txdata, 1, FRAM_RW_TIMEOUT);
}
